...
class FrozenBatchNorm2d(torch.nn.Module):
    ...
    def __init__(self, n):
        ...
        self.register_buffer(name="weight", tensor=torch.ones(n))       # register_buffer 表示不被梯度跟踪
        self.register_buffer(name="bias", tensor=torch.zeros(n))
        self.register_buffer(name="running_mean", tensor=torch.zeros(n))
        self.register_buffer(name="running_var", tensor=torch.ones(n))
...
def build_backbone(args):
    ...
    train_backbone = args.lr_backbone > 0   # * Train
